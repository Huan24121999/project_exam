            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div id="example1_filter" class="dataTables_filter">
                        <label class="">Tìm kiếm theo Nghề nghiệp:
                        ...
                        <label class="display">Tìm kiếm theo Địa chỉ:
                        ...
                        <label class="display">Tìm kiếm theo Chi Nhánh:
                ...
                <div class="col-sm-12">
                    <table  class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tr role="row">
                            ...
                            <th  tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column descending" aria-sort="ascending">Tên doanh nghiệp</th>
                            <th  tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" >Mã doanh nghiệp</th>
                            <th  tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" >Email liên hệ</th>
                            <th  tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" ></th>Chi tiếts</th>
                        </tr>
                        </thead>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center" id="name_organization">Tên Doanh Nghiệp</h3>

                            <p class="text-muted text-center" id="enable">Trạng thái hoạt động</p>

                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>MÃ DB</b> <a class="float-right" id="id_database">09798777334</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Điện thoại</b> <a class="float-right" id="phone_number">09798777334</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Mã doanh nghiệp</b> <a class="float-right" id="code_organization">XHFHAKFKHA</a>
                                </li>
                                <li class="list-group-item">
                            ...
                            <a href="#" class="btn btn-primary btn-block" id="nextchild"><b>Xem các chi nhánh</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                ...
                <!-- /.col -->
                <div class="col-md-9" id="profile-organization">
                    <div class="card">
                ...
                <div class="col-md-9 display" id="detail">
                    <div class="card" id="datatable-detail">
                        <div class="card-header">
                            <h3 class="card-title">DANH SÁCH CÁC CHI NHÁNH
                                <button type="button" class="btn btn-primary" id="back-level1">QUAY LẠI</button>
                            </h3>
...
<%--                end col--%>
                <div class="col-md-9 display" id="detail-level3">
                    <div class="card" id="datatable-detail-level3">
                        <div class="card-header">
                            <h3 class="card-title">DANH SÁCH CÁC PHÒNG BAN
                                <button type="button" class="btn btn-primary" id="back-level2">Quay Lại</button>
                            </h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table  class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody id="organization-detail-level3">
                                            <tr role="row" >
                                                <td class="">
                                                    <input class="form-control form-control-navbar " type="search" placeholder="Search" aria-label="Search" id="stt-detail-level3">
                                                </td>
                                                <td class="">
                                                    <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" id="name-detail-level3">
                                                </td>
                                                <td class="">
                                                    <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" id="code-detail-level3">
                                                </td>
                                                <td class="">
                                                    <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" id="eportal-detail-level3">
                                                </td>
                                                <td class="">
                                                    <button type="button" class="btn btn-primary" id="search-detail-level3">TÌM KIẾM</button>
                                                </td>
                                            </tr>
                                            </tbody>
                                            <tfoot>
...
<%--                end col--%>
                <div class="col-md-9 display" id="profile-organization-level3">
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item active"><a class="nav-link" href="#activity_level3" data-toggle="tab">THÔNG TIN PHÒNG BAN </a></li>

                                <li class="nav-item"><a class="nav-link" href="#settings_level3" data-toggle="tab">CHỈNH SỬA</a></li>
                                <li class="nav-item"><a class="nav-link btn-primary" href="#" data-toggle="tab" id="close_level3">CLOSE</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="activity_level3">
                                    <!-- Post -->
                                    <div class="post">
                                        <div class="user-block">
                                            <img class="img-circle img-bordered-sm" src="resources/img/tamviet.jfif" alt="user image">
                                            ...
                                            <span class="description" id="modify_date1_level3">Thời gian chỉnh sửa</span>
                                        </div>
                                        <!-- /.user-block -->
                                        <p id="description-level3">
                                            Lorem ipsum represents a long-held tradition for designers,
                                            typographers and the like. Some people hate it and argue for
                                            its demise, but others ignore the hate as they create awesome
                                            tools to help create filler text for everyone from bacon lovers
                                    ...
                                    <div class="post clearfix">
                                        <div class="user-block">
                                            ...
                                            <span class="description" id="modify_date2_level3">Thời gian chỉnh sửa</span>
                                        </div>
                                        <!-- /.user-block -->
                                        <p id="career_level3">
                                            Hiền thị thêm thông tin doanh nghiệp ở đây!
                                        </p>
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            <img class="img-circle img-bordered-sm" src="resources/img/tamviet.jfif" alt="User Image">
                                            <span class="username">
                                              <a href="#">HÌNH ẢNH PHÒNG BAN</a>
                                              <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                            </span>
                                            <span class="description" id="modify_date3_level3">Thời gian chỉnh sửa</span>
                                        </div>
                                        <!-- /.user-block -->
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                ...
                                <div class="tab-pane" id="settings_level3">
                                    <form class="form-horizontal">
                                        BẠN PHẢI ĐƯỢC CÁP QUYỀN MỚI ĐƯỢC THAY ĐỔI THÔNG TIN PHÒNG BAN
                                    </form>
                                </div>
                                <!-- /.tab-pane -->
                            </div>
