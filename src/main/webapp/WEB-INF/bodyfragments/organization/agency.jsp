            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div id="example1_filter" class="dataTables_filter">
                        ...
                        <label class="">Tìm kiếm theo Tổ chức :
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="#" id="next_child" class="btn btn-primary btn-block"><b>Xem thông tin phòng ban</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
...
<script src="resources/js/organization/agency.js" defer></script>