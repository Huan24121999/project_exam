...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <div class="etpinfopm displaynone" id="up-load-giay-phep">
                <div class="etpinfopi3 form-group">
                    <label><a href="#" id="link-giay-phep" target="_blank" value="0"></a></label>
                    <input type="file" name="" id="anh-upload" class="check-modifile-ttdn">
                    <button class="btn btn-primary displaynone" id="upload-anh">Xem</button>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-6">
            ...
            <div class="text-left">
                <button class="btn btn-primary displaynone" id="save-doanh-nghiep">Lưu lại</button>
<%--                <label ><span>Trạng Thái</span></label>--%>
<%--                <select class="js-example-basic-single select2" name="state" id="select3" style="width: 100%">--%>
<%--                    <option id="enable">kích hoạt</option>--%>
<%--                    <option id="unenable">Tạm dừng</option>--%>
<%--                    <option value="AL">xóa</option>--%>
<%--                </select>--%>
                <span class="help-block"></span>

              <%--  <button class="btn btn-primary displaynone" id="xoa-doanh-nghiep">XÓA</button>--%>
                <!-- Button trigger modal -->
                <button type="button" class="btn btn-primary displaynone" data-toggle="modal" data-target="#xoa-doanh-nghiep" id="xoa-dn">
                    XÓA
                </button>

                <!-- Modal -->
                <div class="modal fade" id="xoa-doanh-nghiep" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Bạn có thể sẽ mất toàn bộ dữ liệu của doanh nghiệp, bạn có muốn tiếp tục không?
                            </div>
   ...
   <div class="row displaynone" id="giay-phep">
       <div class="col-md-12" >
           <div class="embed-responsive embed-responsive-16by9">
               <iframe class="embed-responsive-item " src="" frameborder="0" allowfullscreen="" id="giay-phep-hoat-dong"></iframe>
           </div>
       </div>
   </div>
    <div class="row">
        <div class="col-md-12" id="detail">
            <div class="card" id="datatable-detail">
                <div class="card-header">
                    <h3 class="card-title">DANH SÁCH CÁC CHI NHÁNH ĐƯỢC QUẢN LÝ
                        <a href="./thong-tin-chi-nhanh?id=0">
                            <button type="button" class="btn-primary btn displaynone" id="them-moi-chi-nhanh">Thêm Mới</button>
                        </a>
                    </h3>
                </div>
                <!-- /.card-header -->
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="example1" rowspan="1" colspan="1" >Mã chi nhánh</th>
                                    ...
                                    <tbody id="danh-sach-chi-nhanh">
                                           <%-- <tr role="row">
                                            ...
                                            <tr role="row" class="data-detail">
                                                ...
                                                <td class="">NULL</td>
                                                <td class="">NULL</td>
                                                <td class=""><button type="button" class="btn btn-outline-primary" value="52">Chi tiết</button></td>
                                            </tr>
